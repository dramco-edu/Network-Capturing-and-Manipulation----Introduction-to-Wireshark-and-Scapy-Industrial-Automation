...
\author{Gilles Callebaut\\ \texttt{gilles.callebaut@kuleuven.be}\\ Fan Wu\\\texttt{fan.wu@kuleuven.be}}
...
\begin{versionhistory}
    ...
    \vhEntry{\currentversion}{09/11/2022}{GC}{Extended the tracerouting use case and explicitly mentioned that students need to communicate with their teaching assistant and not only me.}
    \vhEntry{\currentversion}{14/12/2022}{GC}{Added formatting requirement for the final \texttt{.zip} file.}
...
\emph{But before delving into the lab session, take a look at the evaluation of this course detailed in \cref{sec:evaluation}. In this manner, you know how to proceed with the lab session and are aware of the timeline and expectations.}
